...
class SupervisorAgentTask extends Component {
    constructor(props) {
        super(props);
        ...
        return ( 
            ...
            <Navbar expand="md">
              <Nav className="d-md-down-none" navbar>
                ...
                <NavItem className="px-3">
                  <NavLink tag={RRNavLink} to="/pmtasks/agent" activeClassName="active" className="nav-link" >Tasks</NavLink>
                </NavItem>
                </Nav>
           </Navbar>
...
export default SupervisorAgentTask;